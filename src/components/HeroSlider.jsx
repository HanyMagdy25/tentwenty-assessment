...
const FarmHeroSlider = () => {
  ...
  return (
    <div className="relative h-[100dvh] bg-gray-100 overflow-hidden">
          ...
          {slides.map((slide, index) => (
            <div key={index} className="swiper-slide">
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-1/2 left-14 md:left-28 transform -translate-y-1/2 flex items-center justify-center z-10">
                  <motion.div
      ...
      {/* Bottom Navigation */}
      <div className="absolute bottom-12 left-14 md:left-28 z-20 flex items-center gap-8">
        {/* Thumbnail with Next Button */}
        <motion.div
          className="relative w-36 h-36 overflow-hidden shadow-2xl 
